...
This file is the quick-reference operating contract for ctor-kotlin. The longer
...
ctor-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ctor`](https://crates.io/crates/ctor). Upstream Rust is the behavioral oracle while the
