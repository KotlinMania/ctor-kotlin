...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Ctor.swiftmodule/`
...
//      `import Ctor` above would fail at compile time.
//
//   2. The static archive `libCtor.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Ctor" }` and
//      `flattenPackage = "io.github.kotlinmania.ctor"` configuration in
